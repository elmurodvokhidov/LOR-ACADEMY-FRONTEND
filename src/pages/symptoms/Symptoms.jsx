        ...
        <div className="container">
            <div className="flex items-center justify-between mb-8">
                <div className="flex flex-col justify-start text-sm  pc:text-xl">
                    <h1 className="text-xl pc:text-3xl">Bo'limlar ro'yhati</h1>
                    <p>Miqdor <span className="inline-block w-4 h-px mx-1 align-middle bg-black"></span> <span>{symptoms?.length}</span></p>
                </div>
                ...
                <table className="w-full text-sm pc:text-xl text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        {symptoms?.length > 0 ?
                            ...
                            <tr><td className="py-12 text-center text-lg pc:text-xl odd:bg-white even:bg-gray-50" colSpan={10}>Bo'lim mavjud emas</td></tr>}
                    </tbody>
                </table>
            </div>
