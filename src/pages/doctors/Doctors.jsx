    ...
    return (
        <div className="container">
            <div className="flex items-center justify-between mb-8">
                <div className="flex flex-col justify-start text-sm pc:text-xl">
                    <h1 className="text-xl pc:text-3xl">Shifokorlar ro'yhati</h1>
                    <p>Miqdor <span className="inline-block w-4 h-px mx-1 align-middle bg-black"></span> <span>{doctors?.length}</span></p>
                </div>
                ...
                <table className="w-full text-sm pc:text-xl text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        {doctors?.length > 0 ?
                                ...
                                <tr key={doctor._id} className="odd:bg-white even:bg-gray-50 border-b">
                                    ...
                                    <td onClick={() => handleCopy(doctor?.phoneNumber)} className="px-6 py-4 text-blue-600 flex items-center gap-1 cursor-pointer">
                                        ...
                                        <img
                                            ...
                                            alt="copy svg"
                                            className="cursor-pointer pc:size-5" />
                                    </td>
                            ...
                            <tr><td className="py-12 text-center text-lg pc:text-xl odd:bg-white even:bg-gray-50" colSpan={10}>Shifokor mavjud emas</td></tr>}
                    </tbody>
                </table>
            </div>
